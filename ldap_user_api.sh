...
#
#-------------------------------------------------------------------------------------
# This script is an example on how to manage LDAP Users with API, 
#
#set -x
...
#----------------------------------------------------------------------
#  Create a LDAP user (authentication is done by the LDAP server)
#----------------------------------------------------------------------
create_ldap_user() {

display "Create a new LDAP User"
